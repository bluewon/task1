...
//  task1
//
//  Created by Quan Tran on 6/29/17.
...
public class LTHRadioButton: UIView {
    ...
    public var selectedColor = #colorLiteral(red: 0.1490196078, green: 0.7568627451, blue: 0.5803921569, alpha: 1) {
        willSet {
    ...
    public var deselectedColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.2) {
        willSet {
    ...
    private let innerIncreaseDelta: CGFloat = 1
    ...
    private func commonInit(diameter: CGFloat, selectedColor: UIColor?, deselectedColor: UIColor?) {
        ...
        circle.layer.borderWidth  = diameter * 0.04 ////////
        circle.frame.size         = CGSize(width: diameter , height: diameter )
        circle.center             = center
        
        addSubview(innerCircle)
        innerCircle.backgroundColor    = .clear
        innerCircle.layer.cornerRadius = innerCircleDiameter * 0.4
        innerCircle.layer.borderColor  = self.selectedColor.cgColor
        innerCircle.layer.borderWidth  = 0
        innerCircle.frame.size         = CGSize(width: innerCircleDiameter - 2, height: innerCircleDiameter - 2)
